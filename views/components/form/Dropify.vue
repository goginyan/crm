...
<style>
    ...
    .dropzone-img span{position: absolute;padding: 3px 8px;background: rgba(255,255,255,.5);right: 3px;top: 5px;border-radius: 3px;z-index: 999;width: 5px;border: 2px solid #ccc;width: max-content}
    .dropzone-img span:hover {transition: .3s all;background: #fff}
